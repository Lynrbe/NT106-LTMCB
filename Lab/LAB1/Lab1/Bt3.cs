...
namespace Lab1
{
    public partial class Bt3 : Form
    {
        ...
        public static string soSangChu(double gNum)
        {
            if (gNum == 0)
                return "Không";
            ...
            try
            {
                int so = Int32.Parse(So.Text);
                  kq.Text = soSangChu(so);
            }
            ...
            {
                MessageBox.Show("Kết quả phép toán bị tràn số!", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
